...
module.exports.decryptOriginal = function(delegating_sk, capsule, ciphertext) {
    try {
        ...
        const len0 = WASM_VECTOR_LEN;
        wasm.decryptOriginal(retptr, delegating_sk.__wbg_ptr, capsule.__wbg_ptr, ptr0, len0);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        var r2 = getInt32Memory0()[retptr / 4 + 2];
...
module.exports.generateKFrags = function(delegating_sk, receiving_pk, signer, threshold, shares, sign_delegating_key, sign_receiving_key) {
    try {
        ...
        wasm.generateKFrags(retptr, delegating_sk.__wbg_ptr, receiving_pk.__wbg_ptr, signer.__wbg_ptr, threshold, shares, sign_delegating_key, sign_receiving_key);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
    ...
    */
    verify(capsule, verifying_pk, delegating_pk, receiving_pk) {
        try {
            ...
            _assertClass(delegating_pk, PublicKey);
            _assertClass(receiving_pk, PublicKey);
            wasm.capsulefrag_verify(retptr, ptr, capsule.__wbg_ptr, verifying_pk.__wbg_ptr, delegating_pk.__wbg_ptr, receiving_pk.__wbg_ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var r2 = getInt32Memory0()[retptr / 4 + 2];
            if (r2) {
...
class CapsuleWithFrags {
    ...
    */
    withCFrag(cfrag) {
        _assertClass(cfrag, VerifiedCapsuleFrag);
        const ret = wasm.capsulewithfrags_withCFrag(this.__wbg_ptr, cfrag.__wbg_ptr);
        return CapsuleWithFrags.__wrap(ret);
    }
    /**
    ...
    */
    decryptReencrypted(receiving_sk, delegating_pk, ciphertext) {
        try {
            ...
            const ptr0 = passArray8ToWasm0(ciphertext, wasm.__wbindgen_malloc);
            const len0 = WASM_VECTOR_LEN;
            wasm.capsulewithfrags_decryptReencrypted(retptr, this.__wbg_ptr, receiving_sk.__wbg_ptr, delegating_pk.__wbg_ptr, ptr0, len0);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var r2 = getInt32Memory0()[retptr / 4 + 2];
            var r3 = getInt32Memory0()[retptr / 4 + 3];
...
class EncryptedKeyFrag {
    ...
    */
    constructor(signer, recipient_key, hrac, verified_kfrag) {
        ...
        const ret = wasm.encryptedkeyfrag_new(signer.__wbg_ptr, recipient_key.__wbg_ptr, hrac.__wbg_ptr, verified_kfrag.__wbg_ptr);
    ...
    */
    decrypt(sk, hrac, publisher_verifying_key) {
        try {
            ...
            wasm.encryptedkeyfrag_decrypt(retptr, this.__wbg_ptr, sk.__wbg_ptr, hrac.__wbg_ptr, publisher_verifying_key.__wbg_ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var r2 = getInt32Memory0()[retptr / 4 + 2];
            if (r2) {
...
class HRAC {
    ...
    */
    constructor(publisher_verifying_key, bob_verifying_key, label) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.hrac_new(publisher_verifying_key.__wbg_ptr, bob_verifying_key.__wbg_ptr, ptr0, len0);
        this.__wbg_ptr = ret >>> 0;
        return this;
    }
    /**
    ...
    */
    verifyWithDelegatingKey(verifying_pk, delegating_pk) {
        try {
            ...
            _assertClass(verifying_pk, PublicKey);
            _assertClass(delegating_pk, PublicKey);
            wasm.keyfrag_verifyWithDelegatingKey(retptr, ptr, verifying_pk.__wbg_ptr, delegating_pk.__wbg_ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var r2 = getInt32Memory0()[retptr / 4 + 2];
            if (r2) {
    ...
    */
    verifyWithReceivingKey(verifying_pk, receiving_pk) {
        try {
            ...
            _assertClass(verifying_pk, PublicKey);
            _assertClass(receiving_pk, PublicKey);
            wasm.keyfrag_verifyWithReceivingKey(retptr, ptr, verifying_pk.__wbg_ptr, receiving_pk.__wbg_ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var r2 = getInt32Memory0()[retptr / 4 + 2];
            if (r2) {
    ...
    */
    verifyWithDelegatingAndReceivingKeys(verifying_pk, delegating_pk, receiving_pk) {
        try {
            ...
            _assertClass(delegating_pk, PublicKey);
            _assertClass(receiving_pk, PublicKey);
            wasm.keyfrag_verifyWithDelegatingAndReceivingKeys(retptr, ptr, verifying_pk.__wbg_ptr, delegating_pk.__wbg_ptr, receiving_pk.__wbg_ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var r2 = getInt32Memory0()[retptr / 4 + 2];
            if (r2) {
